...
import com.example.week5_0706012110016.model.ProductionCompany
...
class CompanyAdapter(private val dataSet: List<ProductionCompany>) :
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        init {
            ...
            imgset = view.findViewById(R.id.companylogo)
        }
    }
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(viewGroup.context)
            .inflate(R.layout.card_logo_company_list, viewGroup, false)
